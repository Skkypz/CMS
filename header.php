	...
	<ul class="nav navbar-nav"> 
		<li class="dropdown hidden">
			...
			<ul class="dropdown-menu"> 
				<li> <a href="pages/buttons.php">Buttons</a> </li> 
				<li> <a href="pages/icons.php"> <b class="badge pull-right">302</b>Icons </a> </li> 
				<li> <a href="pages/grid.php">Grid</a> </li> 
				<li> <a href="pages/widgets.php"> <b class="badge bg-primary pull-right">8</b>Widgets </a> </li> 
				<li> <a href="pages/components.php"> <b class="badge pull-right">18</b>Components </a> </li> 
				<li> <a href="pages/list.php">List groups</a> </li> 
				<li> <a href="pages/table.php">Table</a> </li> 
				<li> <a href="pages/form.php">Form</a> </li> 
				<li> <a href="pages/chart.php">Chart</a> </li> 
				<li> <a href="pages/calendar.php">Fullcalendar</a></li> 
			</ul>
		</li> 
		...
		<li class="dropdown hidden">
			...
			<ul class="dropdown-menu"> 
				...
				<li> <a href="pages/dashboard-1.php">Dashboard one</a> </li> 
				<li> <a href="pages/gallery.php">Gallery</a> </li> 
				<li> <a href="pages/profile.php">Profile</a> </li> 
				<li> <a href="pages/signin.php">Signin page</a> </li> 
				<li> <a href="pages/signup.php">Signup page</a> </li> 
			</ul>
		</li> 
	</ul>
...
<!--<form class="navbar-form navbar-left m-t-sm" role="search"> 
		<div class="form-group"> 
			<div class="input-group input-s"> 
				...
				<span class="input-group-btn"> <button type="submit" class="btn btn-sm btn-primary btn-icon"><i class="fa fa-search"></i></button> </span> 
			</div> 
		</div> 
	</form>  -->
