	...
	<ul class="nav navbar-nav"> 
		<li class="dropdown">
			...
			<ul class="dropdown-menu"> 
				...
				<li> <a href="icons.php"> <b class="badge pull-right">302</b>Icons </a> </li> 
				<li> <a href="grid.php">Grid</a> </li> 
				<li> <a href="widgets.php"> <b class="badge bg-primary pull-right">8</b>Widgets </a> </li> 
				<li> <a href="components.php"> <b class="badge pull-right">18</b>Components </a> </li> 
				<li> <a href="list.php">List groups</a> </li> 
				<li> <a href="table.php">Table</a> </li> 
				<li> <a href="form.php">Form</a> </li> 
				<li> <a href="chart.php">Chart</a> </li> 
				<li> <a href="calendar.php">Fullcalendar</a></li> 
			</ul>
		</li> 
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu"> 
				...
				<li> <a href="dashboard-1.php">Dashboard one</a> </li> 
